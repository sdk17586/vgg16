...
class Trainer():
    ...
    def setLogger(self):
        logger.add(self.pathInfo["logPath"], level="INFO")
        self.Log = logger
    ...
    def setHyperParam(self):
        ...
        self.originWeightPath = "/data/sungmin/vgg16/originWeight"
...
if __name__ == "__main__":
    ...
    try:
        # img
        data = '{"runType":"train","dataInfo":{"purposeType":"classification","classInfo":[{"classId":"c87f5","className":"cat","color":"#cad274","desc":"","dsId":"e3375","dsName":"[CLF] LG\uc5d4\uc194_Train_dataset","isClick":false,"showTf":true,"sourceClassId":"336ba","sourceClassName":"cat"},{"classId":"c87f1","className":"dog","color":"#cad244","desc":"","dsId":"e337e","dsName":"[CLF] LG\uc5d4\uc194_Train_dataset","isClick":false,"showTf":true,"sourceClassId":"336aa","sourceClassName":"dog"}],"mlType":"vision","sourceType":"file"},"servInfo":{"servIp":"string","servPort":"string","sendResultUrl":"string","sendStatusUrl":"string"},"pathInfo":{"trainPathList":["/data/sungmin/vgg16/sample/catdog","/data/sungmin/vgg16/sample/catdog2"],"modelPath":"/data/sungmin/vgg16","weightPath":"/data/sungmin/vgg16/weight","logPath":"/data/sungmin/vgg16/log/log.log","pvPath":"/data/sungmin/vgg16"},"selectedHyperParam":{"epoch":100,"batchSize":2,"trainRate":{"train":70,"validation":30},"grayScale":"false","optimizer":"adam","learningRate":0.01,"earlyStopping":"true","patience":10,"monitor":"loss","gpuIdx":"auto"},"useClassBalancer":false}'
